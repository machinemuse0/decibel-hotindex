...
fn print_usage() {
  ...
  decibel-hotindex-bench run --features toplingsdb --dataset <dataset-dir> --engine toplingdb --db-path <toplingdb-path> --class serving --workload mixed_market_dashboard --iterations <n> --warmup <n> --access-pattern sequential|uniform|zipfian --seed <seed> --out <report.json>
